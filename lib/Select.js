...
var Select = _react2['default'].createClass({
  ...
  */
	...
	render: function render() {
		...
		var isOpen = this.state.isOpen;
		if(this.props.allowCreate && this.state.inputValue !== '' && !(options.length == 1 && options[0].label === this.state.inputValue)) {
			var newOption = { value: this.state.inputValue, label: 'Add ' + this.state.inputValue + ' ...'};
			this._visibleOptions.unshift(newOption);
		}
